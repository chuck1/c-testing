...
/*	map_abs_str_[ABS_THROTTLE]=            0x06
	map_abs_str_[ABS_RUDDER]=              0x07
	map_abs_str_[ABS_WHEEL   ]=            0x08
	map_abs_str_[ABS_GAS       ]=          0x09
	map_abs_str_[ABS_BRAKE       ]=        0x0a
	map_abs_str_[ABS_HAT0X        ]=       0x10
	map_abs_str_[ABS_HAT0Y         ]=      0x11
	map_abs_str_[ABS_HAT1X          ]=     0x12
	map_abs_str_[ABS_HAT1Y           ]=    0x13
	map_abs_str_[ABS_HAT2X  ]=             0x14
	map_abs_str_[ABS_HAT2Y    ]=           0x15
	map_abs_str_[ABS_HAT3X      ]=         0x16
	map_abs_str_[ABS_HAT3Y        ]=       0x17
	map_abs_str_[ABS_PRESSURE       ]=     0x18*/
	map_abs_str_[ABS_DISTANCE  ]=      "ABS_DISTANCE";
	map_abs_str_[ABS_TILT_X      ]=    "ABS_TILT_Y";
	map_abs_str_[ABS_TILT_Y        ]= "ABS_TILT_X";
	map_abs_str_[ABS_TOOL_WIDTH      ]=  "ABS_TOOL_WIDTH";
	map_abs_str_[ABS_VOLUME  ]= "ABS_VOLUME";
	map_abs_str_[ABS_MISC      ]="ABS_MISC";
	map_abs_str_[ABS_MAX         ]="ABS_MAX";
...
void	js::Event::query(__u32 start, __u32 end, std::map<__u32,char const *> map )
{       
...
void	js::Event::query_absinfo(__u32 abs)
{	
	input_absinfo ai;
...
void js::Event::Set(unsigned int f)
{
	flag_ |= f;
}
...
void js::Event::Read()
{
	...
	while(1)
	{
		...
		if( ( flag_ & js::Event::flag::PRINT ) > 0 )
		{	
