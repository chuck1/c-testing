...
template <typename DistanceMap> class bacon_number_recorder : public boost::default_bfs_visitor
{
	public:
		...
		template <typename Edge, typename Graph>
			void tree_edge(Edge e, const Graph& g) const
			{
				...
				typename boost::graph_traits<Graph>::vertex_descriptor v = target(e, g);
...
template < typename DistanceMap > bacon_number_recorder<DistanceMap> record_bacon_number(DistanceMap d)
{
