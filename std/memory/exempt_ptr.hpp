...
namespace cet {
	...
	template< class E > void swap( exempt_ptr<E> &, exempt_ptr<E> & ) /*noexcept*/;

	template< class E > exempt_ptr<E> make_exempt_ptr( E * ) /*noexcept*/;

	template< class E > bool operator == ( exempt_ptr<E> const &, exempt_ptr<E> const & );
	template< class E > bool operator != ( exempt_ptr<E> const &, exempt_ptr<E> const & );
...
class exempt_ptr
{
	...
	public:
		// --- default c'tor:
		CONSTEXPR_FCTN  exempt_ptr( ) /*noexcept*/ : p( /*nullptr*/NULL )  { }
...
/*		exempt_ptr &
		...
		bool       empty( ) const /*noexcept*/  { return get() == NULL/*nullptr*/; }
	...
	public:
		...
		void     reset( pointer t = NULL/*nullptr*/ ) /*noexcept*/  { p = t; }
